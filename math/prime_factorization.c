/*
    ...
    DATE: 12.02.2019
    DESCRIPTION: This program calculates the prime factorization of a positive
   integer > 1
*/
...
/*
    this type is for the representation of the prim factorization
...
/* int_fac : calculates the prime factorization of positive integers */
Range int_fact(int);
